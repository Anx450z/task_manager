...
class ContainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create container' do
    assert_difference('Container.count') do
      post containers_url, params: { container: { tag: @container.tag, user_id: @container.user_id } }
    end
  ...
  test 'should update container' do
    patch container_url(@container), params: { container: { tag: @container.tag, user_id: @container.user_id } }
